...
export async function handleGenerateDiagram(request: Request) {
  try {
...
/** @deprecated Use POST /api/v2/generate/diagram */
export async function POST(request: Request) {
  const response = await handleGenerateDiagram(request);
  return addLegacyEndpointDeprecation(response, "/api/v2/generate/diagram");
}
