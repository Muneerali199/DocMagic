...
/** Canonical handler — use via /api/v2/generate/resume */
export const handleGenerateResume = withErrorHandling(postHandler);

/** @deprecated Use POST /api/v2/generate/resume */
export async function POST(request: NextRequest) {
  const response = (await handleGenerateResume(request)) as NextResponse;
  return addLegacyEndpointDeprecation(response, "/api/v2/generate/resume");
}
