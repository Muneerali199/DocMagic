  ...
  const plans: PricingPlan[] = [
    {
      ...
      period: "/month",
      description:
        "Perfect for individuals getting started with document automation",
        ...
        <section className="py-16 sm:py-24 lg:py-32 relative overflow-hidden ">
          <div className="container relative z-10 px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mb-12 sm:mb-16 lg:mb-20">
              ...
              <h1 className="modern-display text-3xl sm:text-4xl md:text-5xl lg:text-6xl text-center mb-6 sm:mb-8 mto">
                Choose Your{" "}
            ...
            <div className="grid md:grid-cols-3 gap-8 lg:gap-12 max-w-7xl mx-auto">
              {plans.map((plan, index) => (
                <div
                  key={plan.name}
                  className={`animate-bounce-in delay-${
                    (index + 1) * 100
                  } will-change-transform relative professional-card rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 ${
                ...
                >
                  ...
                  <div className="p-8">
                    ...
                    <div className="text-center mb-8">
                      ...
                      <h3 className="text-2xl font-bold mb-2 bolt-gradient-text">
                        {plan.name}
                      </h3>
                      <div className="flex items-baseline justify-center mb-2">
                        <span className="text-5xl font-bold bolt-gradient-text">
                          {plan.price}
                        </span>
