      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-6 md:gap-8 lg:gap-10 xl:gap-12">
          {features.map((feature, index) => {
            ...
            return (
              <ScrollReveal key={feature.name} animation="fade-in-up" delay={index * 80} threshold={0.1}>
                <div className="group relative">
                  ...
                  <div className={`relative professional-card mobile-card p-5 sm:p-6 md:p-7 lg:p-8 rounded-2xl sm:rounded-3xl hover:scale-[1.02] sm:hover:scale-105 micro-hover-lift border ${theme.borderClass} ${theme.cardClass}`}>
                    <div className={`w-14 h-14 sm:w-16 sm:h-16 mb-5 sm:mb-6 ${theme.gradientClass} rounded-xl sm:rounded-2xl flex items-center justify-center text-white group-hover:scale-110 micro-hover-lift relative touch-target`}>
                      {feature.icon}
        ...
        <ScrollReveal animation="scale-in" delay={200}>
          <div className="text-center mt-12 sm:mt-16 md:mt-20">
            <div className="inline-flex items-center gap-3 sm:gap-4 px-6 sm:px-8 py-3 sm:py-4 rounded-full glass-effect border border-green-200/30 hover:scale-105 micro-hover-lift touch-target">
