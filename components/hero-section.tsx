        ...
        <div className="mx-auto max-w-5xl text-center">
          ...
          >
            <div className="relative z-10 flex items-center gap-2 sm:gap-3">
              <Sparkles className="h-5 w-5 sm:h-6 sm:w-6 text-yellow-500 animate-pulse" aria-hidden="true" />
              <span className="text-base sm:text-lg font-bold bolt-gradient-text">AI-Powered Document Magic</span>
              <Wand2 className="h-5 w-5 sm:h-6 sm:w-6 text-blue-500 animate-bounce" aria-hidden="true" />
            </div>
          </div>
          ...
          <div className="mt-12 sm:mt-14 flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6 px-4 sm:px-0 animate-fade-in-up delay-300 will-change-transform w-full max-w-2xl mx-auto">
            ...
            >
              <Link href="/resume" className="flex items-center justify-center gap-3 sm:gap-4" tabIndex={0}>
                <Sparkles className="h-5 w-5 sm:h-6 sm:w-6 group-hover:animate-spin transition-transform" aria-hidden="true" />
                <span className="font-extrabold">Start Creating Now</span>
                <ArrowRight className="h-5 w-5 sm:h-6 sm:w-6 group-hover:translate-x-2 transition-transform duration-300" aria-hidden="true" />
              </Link>
            </Button>
          ...
          <div className="mt-16 sm:mt-20 lg:mt-24 grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8 lg:gap-10 px-4 sm:px-0">
            <TooltipWithShortcut content="Over 10,000 professional documents successfully created by our users worldwide">
              <Link href="/dashboard/history" className="group relative block">
                ...
                <div className="relative card-coral hover-glow-coral p-8 sm:p-10 rounded-3xl hover:scale-110 transition-all duration-500 sunset-glow animate-fade-in-up delay-400 will-change-transform border-2 border-amber-200/40 dark:border-amber-500/30 shadow-xl hover:shadow-2xl">
                  <div className="text-center">
                    ...
                    <div className="text-muted-foreground text-base sm:text-lg font-bold">Documents Created</div>
                    <div className="text-xs sm:text-sm text-muted-foreground/70 mt-2 font-medium">And counting...</div>
                  </div>
                </div>
              </Link>
            </TooltipWithShortcut>
            ...
            <TooltipWithShortcut content="98% of our users successfully achieve their goals with DraftDeckAI-generated documents">
              <Link href="/resume/ats" className="group relative block">
                ...
                <div className="relative card-sky hover-glow-sky p-8 sm:p-10 rounded-3xl hover:scale-110 transition-all duration-500 bolt-glow animate-fade-in-up delay-500 will-change-transform border-2 border-blue-200/40 dark:border-blue-500/30 shadow-xl hover:shadow-2xl">
                  <div className="text-center">
                    <div className="bolt-gradient-text text-4xl sm:text-5xl lg:text-6xl font-extrabold animate-text-glow text-shadow-professional mb-3">
                      <StatCounter target={98} suffix="%" />
                    </div>
                    <div className="text-muted-foreground text-base sm:text-lg font-bold">Success Rate</div>
                    <div className="text-xs sm:text-sm text-muted-foreground/70 mt-2 font-medium">Proven results</div>
                  </div>
                </div>
              </Link>
            </TooltipWithShortcut>
            ...
            <TooltipWithShortcut content="Average 5-star rating from thousands of satisfied users across all platforms">
              <Link href="/about" className="group relative block">
                ...
                <div className="relative card-mint hover-glow-mint p-8 sm:p-10 rounded-3xl hover:scale-110 transition-all duration-500 ocean-glow animate-fade-in-up delay-600 will-change-transform border-2 border-emerald-200/40 dark:border-emerald-500/30 shadow-xl hover:shadow-2xl">
                  <div className="text-center">
                    <div className="bolt-gradient-text text-4xl sm:text-5xl lg:text-6xl font-extrabold animate-text-glow text-shadow-professional mb-3">
                      <StatCounter target={5} suffix="★" />
                    </div>
                    <div className="text-muted-foreground text-base sm:text-lg font-bold">User Rating</div>
                    <div className="text-xs sm:text-sm text-muted-foreground/70 mt-2 font-medium">Loved by users</div>
                  </div>
                </div>
              </Link>
            </TooltipWithShortcut>
