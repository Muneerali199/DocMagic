...
export function LetterPreview({ letter }: LetterPreviewProps) {
  ...
  return (
    <div className="p-8 max-w-[800px] mx-auto font-serif bg-white text-black">
      ...
      {/* Letter Content */}
      {/* Letter Content */}
      <div className="text-gray-800 leading-relaxed mobile-markdown">
        <ReactMarkdown
          className="prose prose-sm max-w-none prose-headings:font-bold prose-p:mb-4 prose-ul:list-disc prose-ul:pl-4 prose-li:mb-1"
          components={{
