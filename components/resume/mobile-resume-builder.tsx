...
export function MobileResumeBuilder({ templateId, resumeId }: MobileResumeBuilderProps) {
  ...
  const [currentStep, setCurrentStep] = useState<'dashboard' | 'selection' | 'input' | 'preview' | 'job-url' | 'ats-checker'>('dashboard');
            ...
            <Card className="card-sky hover-sky border-2 border-blue-200/50 hover:border-blue-300/70 shadow-xl backdrop-blur-xl">
              <CardHeader className="p-4 sm:p-6 relative">
                <button
                  ...
                  className="absolute top-4 left-4 p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors flex items-center gap-1 text-sm text-muted-foreground hover:text-foreground"
                >
