...
const sampleData = {
  ...
  summary:
    "Results-driven professional with 5+ years of experience in software development and project management. Proven track record of delivering high-quality solutions that drive business growth and improve operational efficiency.",
  experience: [
    {
  ...
  projects: [
    {
      ...
      description:
        "Built scalable e-commerce solution with payment integration serving 100K+ users",
...
export function TemplatePreviewRenderer({ templateId }: TemplatePreviewProps) {
  ...
  return <div style={previewStyle}>{renderTemplate()}</div>;
}
