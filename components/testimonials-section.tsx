      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="mx-auto max-w-4xl text-center mb-16 sm:mb-20">
          ...
          <h2 className="modern-display text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl mb-8 leading-tight font-extrabold">
            <span className="block mb-3 bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 dark:from-white dark:via-gray-100 dark:to-white bg-clip-text text-transparent">
              Trusted by
            </span>
          ...
          <p className="modern-body text-base sm:text-lg lg:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed font-medium px-4 sm:px-0">
            Join thousands of satisfied users who have transformed their document creation process with DraftDeckAI&apos;s
            AI-powered platform.
          </p>
                  ...
                  <Card className="relative professional-card glass-effect group w-full max-w-4xl flex flex-col rounded-3xl border-2 border-blue-200/40 dark:border-blue-500/30 hover:scale-105 transition-all duration-500 shadow-2xl hover:shadow-3xl">
                    <CardHeader className="pb-3 sm:pb-4 p-5 sm:p-7 md:p-8">
                      <div className="flex items-center space-x-3 sm:space-x-5">
                        <div className="relative flex-shrink-0">
                          <Avatar className="ring-2 ring-blue-400/30 h-14 w-14 sm:h-16 sm:w-16 group-hover:ring-blue-400/50 transition-all duration-300">
                        ...
                        <div className="flex-1 min-w-0">
                          <p className="font-bold text-base sm:text-lg md:text-xl group-hover:bolt-gradient-text transition-colors truncate">
                            {testimonial.name}
                          </p>
                    ...
                    <CardFooter className="pt-3 sm:pt-4 p-5 sm:p-7 md:p-8">
                      <div className="flex items-center justify-between w-full">
                        ...
                        <div className="text-xs sm:text-sm text-muted-foreground font-semibold">Verified User</div>
                      </div>
                    </CardFooter>
                  </Card>
                </div>
              ...
              {testimonials.map((_, i) => (
                <button
                  ...
                  className={`rounded-full transition-all duration-300 ${
                    i === currentIndex
                      ? "bg-blue-600 dark:bg-blue-400 w-10 h-2.5 sm:w-12 sm:h-3"
                      : "bg-gray-300 dark:bg-gray-600 w-2.5 h-2.5 sm:w-3 sm:h-3 hover:bg-gray-400 dark:hover:bg-gray-500"
                  }`}
        ...
        <div className="text-center mt-16 sm:mt-20">
          <Link
            href="/auth/register"
            className="inline-flex items-center gap-3 sm:gap-4 px-6 sm:px-8 py-3 sm:py-4 rounded-full glass-effect border-2 border-purple-200/40 dark:border-purple-500/30 hover:scale-105 transition-transform duration-300 shadow-lg hover:shadow-xl"
          >
            <Heart className="h-5 w-5 sm:h-6 sm:w-6 text-pink-600 dark:text-pink-400 animate-pulse" />
...
const testimonials = [
  {
    ...
    content:
      "DraftDeckAI has revolutionized how I create product proposals. The AI understands context perfectly and generates professional documents that impress stakeholders every time.",
  ...
  },
  {
    ...
    content:
      "As a professional writer, I'm amazed by DraftDeckAI's ability to generate compelling content. It's like having a writing partner that never runs out of ideas.",
  ...
  },
  {
    ...
    content:
      "The presentation generator is incredible. It transforms complex data into clear, visually appealing slides that make my findings accessible to any audience.",
  ...
  },
  {
    ...
    content:
      "DraftDeckAI streamlines our HR processes. From offer letters to policy documents, everything is professional, consistent, and created in minutes instead of hours.",
  ...
  },
  {
    ...
    company: "StartupXYZ",
    content:
      "The resume builder helped me land my dream job. The AI created a targeted resume that perfectly highlighted my skills and got me noticed by top companies.",
  ...
  },
  {
    ...
    content:
      "DraftDeckAI has been essential for my academic work. It helps me create professional presentations and research documents that meet university standards.",
