      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 lg:gap-12 mb-12">
          ...
          <div className="space-y-4 text-center sm:text-left">
            ...
            <ul className="space-y-2 sm:space-y-3">
              <li>
                <Link href="/documentation" className="text-sm sm:text-base text-muted-foreground hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-300">
                  Documentation
                </Link>
              </li>
              <li>
          ...
          <div className="space-y-4 text-center sm:text-left">
            ...
            <ul className="space-y-2 sm:space-y-3">
              ...
              <li>
                <Link href="/privacy" className="text-sm sm:text-base text-muted-foreground hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-300">
                  Privacy Policy
                </Link>
              </li>
              <li>
                <Link href="/terms" className="text-sm sm:text-base text-muted-foreground hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-300">
                  Terms of Service
                </Link>
              </li>
            </ul>
